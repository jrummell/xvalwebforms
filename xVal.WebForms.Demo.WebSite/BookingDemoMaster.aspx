...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="divForm" runat="server">
        <fieldset class="booking">
            ...
            <label for="ddlSmokingType">
                Smoking room?</label>
            <asp:DropDownList ID="ddlSmokingType" runat="server">
                <asp:ListItem Text="[Select]" Value="" />
                <asp:ListItem Text="Smoking" Value="Smoking" />
                <asp:ListItem Text="Non-Smoking" Value="NonSmoking" />
            </asp:DropDownList>
            <div>
            ...
            <val:ModelValidator ID="valBooking" runat="server" ModelType="xVal.WebForms.Demo.Booking, xVal.WebForms.Demo"
                ...
                <ModelProperties>
                    ...
                    <val:ModelProperty PropertyName="SmokingType" ControlToValidate="ddlSmokingType" />
                </ModelProperties>
            </val:ModelValidator>
        </fieldset>
    </div>
