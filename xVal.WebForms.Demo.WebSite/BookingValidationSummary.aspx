<%@ Page Title="" Language="C#" MasterPageFile="~/SiteValidationSummary.master" AutoEventWireup="true"
    CodeFile="BookingValidationSummary.aspx.cs" Inherits="BookingValidationSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h1>
        Booking Demo in an Master Page with the ValidationSummary in Master</h1>
